...
public class ConsultasDinamicasAprobados extends JFrame {

	private static final long serialVersionUID = 1L;
	
	public String address="reportes/Excel/Consulta Dinámica Aprobados.xls";  //  @jve:decl-index=0:
	
	private static ConsultasDinamicasAprobados Aprobados = null;
	...
	private ConsultasDinamicasAprobados() {
		super();
		initialize();
	}

	public static ConsultasDinamicasAprobados getAprobados() {
		if (Aprobados == null) {
			Aprobados = new ConsultasDinamicasAprobados();
		}
		return Aprobados;
   }
	...
	private void initialize() {
		...
		this.setTitle("Consultas Dinámicas de Lotes Aprobados");
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			fechanjLabel.setBounds(new Rectangle(804, 3, 60, 19));
			fechanjLabel.setText(fecha_actual);
			iconjLabel = new JLabel();
			iconjLabel.setBounds(new Rectangle(867, 1, 86, 74));
	...
	private JButton getGenerarReportejButton() {
		if (generarReportejButton == null) {
			...
			generarReportejButton.setBounds(new Rectangle(74, 181, 133, 26));
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(listReporteA.isEmpty()){
						if(estadojComboBox.getSelectedIndex() == 0 && formatojComboBox.getSelectedIndex() == 0 && tipojComboBox.getSelectedIndex() == 0 && !fechafinjCheckBox.isSelected() && !fechainiciojCheckBox.isSelected())
							...
							estado = estadojComboBox.getSelectedIndex()+1;}
							String formato = null;
							...
							try {
								...
								for (int i = 0; i < listReporteA.size(); i++) {
									String producto = null;
									int count = 0;
									boolean found = false;
									while (found == false && count < listProducto.size()) {
										if(listProducto.get(count).getCod_producto().equals(listReporteA.get(i).getProducto())){
											producto=listProducto.get(count).getNombre();
											found = true;}
										else count++;
									}
									if(listReporteA.get(i).getCod_estado() == 2)
										getDatosReportedefaultTableModel().addRow(new Object[]{listReporteA.get(i).getCod(), producto, listReporteA.get(i).getFormato(), listReporteA.get(i).getCant_unidades(), listReporteA.get(i).getDiasAprob(),listReporteA.get(i).getFecha_analisis()});
									if(listReporteA.get(i).getCod_estado() == 3)
										getDatosReportedefaultTableModel().addRow(new Object[]{listReporteA.get(i).getCod(), producto, listReporteA.get(i).getFormato(), listReporteA.get(i).getCant_unidades(), listReporteA.get(i).getDiasAprob(),listReporteA.get(i).getFecha_revisado()});
									if(listReporteA.get(i).getCod_estado() == 4)
										getDatosReportedefaultTableModel().addRow(new Object[]{listReporteA.get(i).getCod(), producto, listReporteA.get(i).getFormato(), listReporteA.get(i).getCant_unidades(), listReporteA.get(i).getDiasAprob(),listReporteA.get(i).getFecha_etiquetado()});
									if(listReporteA.get(i).getCod_estado() == 5)
										getDatosReportedefaultTableModel().addRow(new Object[]{listReporteA.get(i).getCod(), producto, listReporteA.get(i).getFormato(), listReporteA.get(i).getCant_unidades(), listReporteA.get(i).getDiasAprob(),listReporteA.get(i).getFecha_envase()});
									if(listReporteA.get(i).getCod_estado() == 6)
										getDatosReportedefaultTableModel().addRow(new Object[]{listReporteA.get(i).getCod(), producto, listReporteA.get(i).getFormato(), listReporteA.get(i).getCant_unidades(), listReporteA.get(i).getDiasAprob(),listReporteA.get(i).getFecha_aprobacion_final()});
								}
						...
						if(estadojComboBox.getSelectedIndex() == 0 && formatojComboBox.getSelectedIndex() == 0 && tipojComboBox.getSelectedIndex() == 0 && !fechafinjCheckBox.isSelected() && !fechainiciojCheckBox.isSelected())
							...
							int estado = estadojComboBox.getSelectedIndex()+1;
							String formato = null;
							if(formatojComboBox.getSelectedIndex() != 0)
								formato = (String)formatojComboBox.getSelectedItem();
							for (int w = listReporteA.size(); w > 0 ; w--) {
	...
	private DefaultTableModel getDatosReportedefaultTableModel() {
		if (datosReportedefaultTableModel == null) {
			datosReportedefaultTableModel = new UneditableTableModel(new Object[]{"Código", "Producto", "Formato", "Cantidad Unidades", "D/A","Fecha de Aprobación"}, 0);
		}
	...
	private JButton getCrearReportejButton() {
		if (crearReportejButton == null) {
			...
			crearReportejButton.setBounds(new Rectangle(227, 181, 147, 26));
			...
			crearReportejButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(estadojComboBox.getSelectedIndex() == 0 && formatojComboBox.getSelectedIndex() == 0 && tipojComboBox.getSelectedIndex() == 0 && !fechafinjCheckBox.isSelected() && !fechainiciojCheckBox.isSelected())
						...
						excel.saveReporteDinamicoA(3,estado,formato,tipo,dateInicio,dateFin);
					}
				}
		   });
		}
